  ...
  return (
    ...
    >
      ...
      <View style={{ backgroundColor: cardBg, borderRadius: 16, borderWidth: 1, borderColor: cardBorder, padding: 20, alignItems: 'center' }}>
        <Sparkles size={48} color="#3b82f6" style={{ marginBottom: 12 }} />
        ...
        <Text style={{ fontSize: 13, color: textMuted, textAlign: 'center', lineHeight: 18 }}>
          Please use the desktop/web version to drag-and-drop images, scale width/height ratios, modify quality percentages with sliders, and compare byte-size gains in real-time.
        </Text>
      </View>
    </ScrollView>
  );
