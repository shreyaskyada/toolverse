  ...
  return (
    ...
    >
      ...
      <View style={{ backgroundColor: cardBg, borderRadius: 16, borderWidth: 1, borderColor: cardBorder, padding: 20, alignItems: 'center' }}>
        <Palette size={48} color="#3b82f6" style={{ marginBottom: 12 }} />
        ...
        <Text style={{ fontSize: 13, color: textMuted, textAlign: 'center', lineHeight: 18 }}>
          Please use the desktop/web version to access the interactive color canvas, custom format generators, and copy outputs instantly.
        </Text>
      </View>
    </ScrollView>
  );
